...
public class frmDecodeWatcher extends JFrame implements ActionListener {
  JCheckBox chxIgnoreNoError = new JCheckBox();
  ...
  Object[] dColumn = new Object[16];
  
  public frmDecodeWatcher() {
    init();
    Timer watcher = new Timer(500, (ActionListener)new Object(this));
    watcher.setInitialDelay(0);
    watcher.start();
  }
  
  private void init() {
    setTitle(ATPMessages.getString("MW.DECODE.WATCHER"));
    ...
    JScrollPane jsp = new JScrollPane((Component)this.jst);
    ...
    this.btnCleanSuccess = new JButton(ATPMessages.getString("MW.DECODE.CLEAR.SUCCESS"));
    this.btnCleanSuccess.setActionCommand("CleanSuccess");
    this.btnCleanSuccess.addActionListener(this);
    this.btnCleanExists = new JButton(ATPMessages.getString("MW.DECODE.CLEAR.EXIST"));
    this.btnCleanExists.setActionCommand("CleanExists");
    this.btnCleanExists.addActionListener(this);
    this.btnSaveErrorLog = new JButton(ATPMessages.getString("MW.DECODE.ERROR.LOG.SAVE"));
    this.btnSaveErrorLog.addActionListener(this);
    this.btnCloseFrame = new JButton(ATPMessages.getString("MW.DECODE.CLOSE"));
    this.btnCloseFrame.setActionCommand("Close");
    this.btnCloseFrame.addActionListener(this);
    pnlControl.add(
        this.btnSaveErrorLog, 
        new GridBagConstraints(
          1, 0, 1, 1, 0.0D, 0.0D, 
          12, 
          0, 
    ...
    pnlControl.add(
        ...
        new GridBagConstraints(
          ...
          new Insets(0, 0, 0, 0), 
          0, 0));
    getContentPane().add(pnlControl, "South");
  }
  
  private void refresh() {
    this.jstm.setDataVector(DecodeBuffer.getBufferStatus2(), this.dColumn);
    TableColumn clum8 = this.jst.getColumnModel().getColumn(7);
    clum8.setCellRenderer((TableCellRenderer)new Object(this));
    TableColumn clum9 = this.jst.getColumnModel().getColumn(8);
    clum9.setCellRenderer((TableCellRenderer)new Object(this));
    TableColumn clum11 = this.jst.getColumnModel().getColumn(9);
    clum11.setCellRenderer((TableCellRenderer)new Object(this));
    TableColumn clum12 = this.jst.getColumnModel().getColumn(10);
    clum12.setCellRenderer((TableCellRenderer)new Object(this));
  ...
  public static void main(String[] args) {
    ...
    db.start();
    com.MiTAC.TRA.ATP.decoder.frmDecodeWatcher de = new com.MiTAC.TRA.ATP.decoder.frmDecodeWatcher();
    de.show();
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getActionCommand().equals(this.btnCloseFrame.getActionCommand())) {
      ...
      try {
        Object[][] status = DecodeBuffer.getBufferStatus();
        StringBuffer sb = new StringBuffer();
        ...
        if (sb.length() != 0) {
          File fileListPath = new File("C:\\ATPMW\\ERROR_LOG\\");
          if (!fileListPath.exists())
            fileListPath.mkdirs(); 
          FileWriter fw = new FileWriter(new File("C:\\ATPMW\\ERROR_LOG\\DECODE_ERROR_" + System.currentTimeMillis() + ".LOG"));
          fw.write(sb.toString());
          fw.close();
          JOptionPane.showMessageDialog(
              this, 
              ATPMessages.getString("MW.DECODE.ERROR.LOG.SAVE.OK"), 
              ATPMessages.getString("MW.GNL.INFO"), 
              1);
        } 
        ...
        JOptionPane.showMessageDialog(
            this, 
            ATPMessages.getString("MW.DECODE.ERROR.LOG.SAVE.OK"), 
            ATPMessages.getString("MW.GNL.ERROR"), 
            0);
      } 
