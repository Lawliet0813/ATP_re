...
public class DrawHistogram extends DrawBase implements drawATP {
  ...
  public DrawHistogram(commonParaSetting paramcommonParaSetting, drawParameters paramdrawParameters, Vector paramVector) {
  ...
  private void _$18225() {
    int i = this._$1632[0];
    int j = this._$2019[0];
    int k = showsoldierRangeToDefence(0);
    ...
    for (byte b = 1; b < this._$18215.length && this._$1632[b] <= DrawBase.mouseX + 600; b++) {
      if (this._$1632[b] >= DrawBase.mouseX - 600) {
        if (j != this._$2019[b]) {
          int n = this._$1632[b] - i;
          this.g2.fillRect(i, j, n, Math.abs(k - j));
          i = this._$1632[b];
          j = this._$2019[b];
        } 
        if (b == this._$18215.length - 1) {
          int n = this._$1632[b] - i;
          this.g2.fillRect(i, j, n, Math.abs(k - j));
          i = this._$1632[b];
          j = this._$2019[b];
    ...
    Color color = this._$18217.darker();
    int m = showsoldierWhereToStand(DrawBase.endTime) - i;
    this.g2.setColor(color);
    this.g2.fillRect(i, j, m, Math.abs(k - j));
  }
