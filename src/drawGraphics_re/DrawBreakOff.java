...
public class DrawBreakOff extends DrawBase implements drawATP {
  ...
  public DrawBreakOff(commonParaSetting paramcommonParaSetting, drawParameters paramdrawParameters, Vector paramVector) {
  ...
  private void _$18225(GeneralPath paramGeneralPath) {
    int i = -1;
    int j = 0;
    for (byte b = 0; b < this._$1632.length && this._$1632[b] <= DrawBase.mouseX + 600; b++) {
      if (this._$1632[b] >= DrawBase.mouseX - 600 && (i != -1 || this._$18216[b] != -1))
        if (i == -1 && this._$18216[b] != -1) {
          i = this._$18216[b];
          j = this._$2019[b];
          paramGeneralPath = new GeneralPath();
          paramGeneralPath.moveTo(this._$1632[b], this._$2019[b]);
        } else if (i != -1 && this._$18216[b] == -1) {
          paramGeneralPath.lineTo(this._$1632[b], j);
          i = -1;
          j = 0;
          this.g2.draw(paramGeneralPath);
        } else if (this._$18216[b] != i) {
          paramGeneralPath.lineTo(this._$1632[b], j);
